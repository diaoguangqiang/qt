...
#include "../../SmartData/maskmainwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_maskmainwidget_t, stringdata) + ofs \
...
const QMetaObject maskmainwidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_maskmainwidget.data,
      qt_meta_data_maskmainwidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_maskmainwidget.stringdata))
