...
{
    version_title->setText(tr("SmartData ") + QString("1.0"));
    ...
    button_list.at(0)->setText(tr("监控"));
    button_list.at(1)->setText(tr("温度"));
    button_list.at(2)->setText(tr("湿度"));
    button_list.at(3)->setText(tr("水质"));
    button_list.at(4)->setText(tr("PH"));
    button_list.at(5)->setText(tr("土壤"));
    button_list.at(6)->setText(tr("报表"));
    button_list.at(7)->setText(tr("帮助"));

    safe_360_label->setText(tr("农业"));
    safe_label->setText(tr("物联"));
}
