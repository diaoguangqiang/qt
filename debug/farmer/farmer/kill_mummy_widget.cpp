...
{
    tip_info_label->setText(tr("tip_info_label ") + QString::number(5, 10) + tr(" no threat found"));
    tip_suggest_label->setText(tr("tip_suggest_label"));
    fast_scan_button->setText(tr("fast_scan_button"));
    full_scan_button->setText(tr("full_scan_button"));
    custom_scan_button->setText(tr("custom_scan_button"));
}
