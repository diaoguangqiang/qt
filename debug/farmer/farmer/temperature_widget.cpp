    ...
    : QWidget(parent)
{
    ...
    right_splitter->setStyleSheet("QSplitter::handle{background-color:green}");

    right_top_widget->setFixedSize(240, 130);
...
void TemperatureWidget::initRight()
{
    ...
    power_button->setFixedSize(200, 70);
    ...
    //main_layout->addWidget(power_button, 0, Qt::AlignLeft);
...
void TemperatureWidget::initLeft()
{
    right_splitter = new QSplitter();
}

void TemperatureWidget::initRightTop()
{
...
void TemperatureWidget::initRightCenter()
{
...
void TemperatureWidget::initRightCenterFunction()
{
...
void TemperatureWidget::initRightBottom()
{
...
void TemperatureWidget::translateLanguage()
{
