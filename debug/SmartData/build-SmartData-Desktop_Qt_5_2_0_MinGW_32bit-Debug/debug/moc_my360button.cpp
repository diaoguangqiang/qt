...
#include "../../SmartData/my360button.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_mainButton_t, stringdata) + ofs \
...
const QMetaObject mainButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_mainButton.data,
      qt_meta_data_mainButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mainButton.stringdata))
...
struct qt_meta_stringdata_main2Button_t {
    QByteArrayData data[1];
    char stringdata[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_main2Button_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_main2Button_t qt_meta_stringdata_main2Button = {
    {
...
const QMetaObject main2Button::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_main2Button.data,
      qt_meta_data_main2Button,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_main2Button.stringdata))
